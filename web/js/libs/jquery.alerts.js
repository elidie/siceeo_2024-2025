...
(function($) {
	...
	$.alerts = {
		...
		alert3: function(message, title, callback) {
			if( title == null ) title = 'Alert';
			$.alerts._show(title, message, null, 'alert3', function(result) {
				if( callback ) callback(result);
			});
		},
	...
	jAlert3 = function(message, title, callback) {
		$.alerts.alert3(message, title, callback);
	}
