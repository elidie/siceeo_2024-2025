...
<%
    ...
    String r="Grupo/reporteDeInscripcion/", cicescini,cicescinilib, cveplan, idcct, grupo;
    int grado;
    ...
    try{
        ...
        r+=cicescinilib+"/repInsc_"+nivel[Integer.parseInt(cveplan)];
        if (!cveplan.equals("3")){
            if (cveplan.equals("1") && grado>1 && grado<6)
                r+="_G2-5";
            else
                r+="_G"+grado;
        }

        parameters.put("cicescini", cicescinilib);
