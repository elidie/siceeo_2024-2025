...
try{
    ...
    idalu=request.getParameter("idalu");
    nom_tot=request.getParameter("nom_tot");
    curp=request.getParameter("curp");
   
    parameters.put("idalu", idalu);
    parameters.put("nom_tot", nom_tot);
