...
public class SICEEO_Excepcion extends Exception {
    ...
    private int tipoError = SICEEO_Excepcion.PLAIN_MESSAGE;
    

    public SICEEO_Excepcion() { }

    public SICEEO_Excepcion(String mensaje) {
        this.mensaje=mensaje;
    }
    
    public SICEEO_Excepcion(int numerror,String mensaje) {
        this.numerror = numerror;
        this.mensaje=mensaje;       
    }
    
    public SICEEO_Excepcion(int numerror, int tipoError, String mensaje) {
        this.numerror = numerror;
        this.mensaje=mensaje;     
        this.tipoError = tipoError;
    }
    
    public SICEEO_Excepcion(int numerror, String mensaje1, String mensaje2) {
        this.numerror = numerror;
        this.mensaje=mensaje1;
        this.mensaje2 = mensaje2;
    }
    
    public SICEEO_Excepcion(int numerror, String mensaje1, String mensaje2, String mensaje3) {
        this.numerror = numerror;
        this.mensaje=mensaje1;
        this.mensaje2 = mensaje2;
