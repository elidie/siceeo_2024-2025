...
public class SICEEO_ValidarCurp {
    ...
    public SICEEO_ValidarCurp (String nombre, String primerApe, String segundoApe, String anioNac, String mesNac, String diaNac, String sexo, String entidad)
    {
        this.VNOM = nombre.trim().toUpperCase();
        this.VAPL1 = primerApe.trim().toUpperCase();
        this.VAPL2 = segundoApe.trim().toUpperCase();
        this.VFEC_ANIO = anioNac;
        this.VFEC_MES = mesNac;
        this.VFEC_DIA = diaNac;
        this.VSEXO = sexo.trim().toUpperCase();
        this.VENT = entidad.trim().toUpperCase();
    }
    ...
    private String P7(String VPASO)
    {
        ...
        for (VI=0; VI<VPASO.length(); VI++)
        {
            ...
            if (VLETRA =='Ä' || VLETRA =='Ë' || VLETRA =='Ï' || VLETRA=='Ö' || VLETRA=='Ü' || VLETRA =='Á' || VLETRA =='É' || VLETRA =='Í' || VLETRA=='Ó' || VLETRA=='Ú') 
            {
               ...
               if (VLETRA=='Ë' || VLETRA=='Ë') VPASO = VPASO.substring(0,VI)+'E'+VPASO.substring(VI+1);
