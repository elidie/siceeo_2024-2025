...
//************************************************************************************************************    
    ...
    private void NewIngreso (String tipo, String texto1, String texto2, String [] tipoMensaje)
    {
        ...
        else if (tipo.equals("ALUMNO_AUN_INSCRITO")){ tipoMensaje[0]= this.WARNING;   tipoMensaje[1]= "Est"+(texto2.equals("o")?"e":"a")+" alumn"+texto2+" se encuentra registrad"+texto2+" en otra escuela \ny SICEEO no permite el nuevo ingreso mientras esté dad"+texto2+" de alta en otra escuela.\n\nSolicite apoyo a su Unidad Delegacional Regional (UDR).";  }
